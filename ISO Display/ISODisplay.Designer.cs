namespace EmulationAssistant
{
	partial class ISODisplay
	{
		...
		private void InitializeComponent()
		{
			...
			this.exePathDialog = new System.Windows.Forms.OpenFileDialog();
			...
			this.XmlUrlBox.Size = new System.Drawing.Size(200, 20);
			...
			this.launchVM.Location = new System.Drawing.Point(940, 231);
			...
			this.exePath.Location = new System.Drawing.Point(890, 110);
			this.exePath.Name = "exePath";
			this.exePath.Size = new System.Drawing.Size(96, 13);
			this.exePath.TabIndex = 9;
			this.exePath.Text = "Path to executable";
			// 
			// exePathBox
			// 
			this.exePathBox.Location = new System.Drawing.Point(890, 126);
			this.exePathBox.Name = "exePathBox";
			this.exePathBox.Size = new System.Drawing.Size(197, 20);
			this.exePathBox.TabIndex = 10;
			this.exePathBox.DoubleClick += new System.EventHandler(this.exePathBox_DoubleClick);
			// 
			// exePathDialog
			// 
			this.exePathDialog.Filter = "EXE (*.exe) | *.exe";
			// 
			// ISODisplay
			// 
		...
		private System.Windows.Forms.OpenFileDialog exePathDialog;
	}
}